...
export default function WhyChooseUs() {
  return (
    <section className="relative bg-gradient-to-r from-gray-900 via-black to-gray-900 py-20 px-6 lg:px-20 text-center text-white overflow-hidden">
      {/* Glow effect background */}
      <div className="absolute inset-0 bg-gradient-radial from-yellow-400/20 to-transparent blur-3xl animate-pulse"></div>

      <div className="relative max-w-7xl mx-auto text-center">
        {/* Heading */}
        <h2 className="text-3xl md:text-5xl font-extrabold text-yellow-400 drop-shadow-lg animate-pulse">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-left">
          {[
            ...
            >
              <h3 className="text-lg font-semibold text-yellow-300 inline-flex items-center gap-2 group-hover:text-yellow-400 transition-colors">
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-4">
          <a
            href="#"
            className="px-6 py-3 rounded-2xl bg-yellow-400 text-black font-semibold shadow-md hover:bg-yellow-500 transition transform hover:scale-110"
          >
            🚀 Join Now
          </a>
          <a
            href="tel:+91XXXXXXXXXX"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-yellow-400 text-black font-semibold shadow-md hover:bg-yellow-500 transition transform hover:scale-110"
          >
            <IoIosCall size={20} />
            Call Us
          </a>
